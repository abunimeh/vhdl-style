...
class CheckBasicIndent(SyntaxRule):
    """Check basic indentation: nested declarations and statements must be
       indented.  Elements of complex constructions (if-elsif-then, case-end,
       function-end, procedure-end, while-end, for-end, loop-end, ...)
       must be on the same column.

       The only exception is for case statement with a simple assignment
       for each alternative."""

    rulename = 'BasicIndentation'
